...
<footer id="footer" class="footer">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-4 mb-4 mb-md-0 msg">
                <h6>About US</h6>
                <p class="text-justify">
                    CineVerse는 특별함보다는 기본에 충실하여<br>
                    고객분들의 즐거운 일상을 조성하는<br>
                    프로젝트 팀입니다.<br>
                </p>
            </div>

            <div class="col-sm-4 col-md-2 mb-4 mb-md-0 msg">
            ...
            <div class="col-sm-4 col-md-2 mb-4 mb-md-0 msg">
                ...
                <ul class="footer-links">
                    <li><a href="https://www.sw.or.kr/">한국소프트웨어산업협회</a></li>
    ...
    <div class="container">
        <div class="copyright-wrapper">
            <div class="col-md-8 col-sm-8 col-xs-12 msg">

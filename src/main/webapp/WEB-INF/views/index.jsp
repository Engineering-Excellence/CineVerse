...
<body>
	...
	<div class="header">
		...
		<div class="main-menu">
			<a href="/movie/list" class="menu-list-name">전체영화</a> <a
				href="/movie/ticket" class="menu-list-name">예매현황</a> <a
				href="/board/list" class="menu-list-name">게시판</a> <a
				href="/note/note" class="menu-list-name">쪽지</a>
	...
	<div class="fullpage">
			...
			<main class="flex__col">
				...
				<section class="clip flex">
					<div class="clip__inner flex__col">
						...
						<p>
							SOTD Challenge : Insprired by <a href="https://aanstekelijk.nl/">aanstekelijk.nl</a>
							website animation (SOTD, Apr 13, 2023)
						</p>
						<figure>
                        ...
                        <defs>
                            <clipPath id="svgClipPath"
                                ...
                                <path
								d="M0.648438 0.00390625 L0.296875 0.00390625 L0.0976562 0.15625 L-0.00390625 1.003906 L0.644531 1.003906 L0.820312 0.882812 ZM0.648438 0.00390625" />
                                <clipPath>
                        </defs>
                    </svg>
					</div>
		...
		<div class="section main-section2" >
				<div class='wrapper'>
					<div>
						<!-- <h2 class="boxoffice-title neon">일일박스오피스</h2> -->
						<div class="boxoffice-title logo"><b>일<span>일</span>박스<span>오</span>피스</b></div>
					</div>
					...
					<div>
						<div class="boxoffice-title logo"><b>주<span>간</span>박스<span>오</span>피스</b></div>
					</div>
		...
		<div class="section main-section4">
			<div class="Background">
				<h1>
					<br> <br> <br> <br> <br> <br>이런 영화는 <Br>어떠세요?
				</h1>
				<sec:authorize access="isAuthenticated()">
					<div class="title-loved">
						<h3>찜목록을 기반으로</h3>
						<h3>추천해드립니다!</h3>
					</div>
				</sec:authorize>

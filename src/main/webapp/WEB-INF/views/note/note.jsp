    ...
    <div class="wrapper">
        <div class="note-container">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                ...
                                aria-controls="profile-tab-pane" aria-selected="false">Search
                        </button>
                    </li>
                </ul>
            ...
            <div class="right">
                ...
                <div class="write">
                    <input type="hidden" id="myAccount" value="${data.username}"
                           name="noteWriter"> <%-- 발신인 - 현재 접속중인 계정 --%>
                    <input type="hidden" id="noteListener" class="partnerName" value="${partnerName}"
                           name="noteListener"> <%-- 수신인 -접속중인 아이디를 값으로 보냈기에 자기혼잣말이 출력되었음 --%>
